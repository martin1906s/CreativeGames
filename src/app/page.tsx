  ...
  return (
    <main>
      <header>
        ...
        <p>La mejor forma de aprender siempre es divirtiéndose, y qué mejor forma de hacerlo que a través del juego. Ahora tenemos la suerte de disponer de muchos juegos online para niños y, además, ¡gratis! Tienes una variedad de juegos adaptados para niños de 3 a 5 años de edad. ¡Seguro que a tus niños les encantarán!</p>
